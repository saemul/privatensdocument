...
class Moid
{
    ...
    function __construct()
    {
        ...
        $this->dir_read = 'https://'.$_SERVER['SERVER_NAME'].'/modules/addons/privatensdocument/files/';
    }
...
SQL;
    ...
    private function _requirement_page($vars){
         return array(
            ...
            'breadcrumb'   => array('index.php?m=privatensdocument&page=requirement'=>'Domain Document'),
    ...
    private function _client_home($vars,$msg=''){
         return array(
            'pagetitle'    => 'Domain document',
            'breadcrumb'   => array('index.php?m=privatensdocument'=>'Domain document'),
