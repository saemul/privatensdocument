...
<div class="container-fluid">
    ...
    <ul class="nav nav-tabs">
      <li role="presentation" ><a href="./index.php?m=privatensdocument">Upload Document</a></li>
      <li role="presentation" class="active"><a href="./index.php?m=privatensdocument&page=requirement">Domain Document</a></li>
    </ul>
</div>
