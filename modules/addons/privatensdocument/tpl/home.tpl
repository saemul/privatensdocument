...
<div class="container-fluid">
    <ul class="nav nav-tabs">
      ...
      <li role="presentation"><a href="./index.php?m=privatensdocument&page=requirement">Domain Document</a></li>
    </ul>
</div>
<div class="container-fluid">
	<div class="row">
	   ...
	   <blockquote>
    	...
    	<form action="./index.php?m=privatensdocument&page=upload" class="dropzone" id="my-awesome-dropzone" enctype="multipart/form-data">
          <div class="fallback">
...
<form method="post" action ="./index.php?m=privatensdocument&page=set_doc">
<!-- Modal -->
    ...
    init:function(){
      ...
      self.on("queuecomplete", function (progress) {
        $('.meter').delay(999).slideUp(999);
            window.location.href ='./index.php?m=privatensdocument';
      });
